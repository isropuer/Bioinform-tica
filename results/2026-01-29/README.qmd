...
[@Slater2005] (corchetes + @ para que aparezca como una cita), y el programa [`muscle`](https://www.drive5.com/muscle5/)[@Edgar2022].
...
| cd (change director) ..     | Cambiar al directorio superior |
...
| rm -r (remove -recursivo) a   | Eliminar el *directorio* "a" y su contenido |
